...
\newglossaryentry{pi}{name={\ensuremath{\pi}},sort=pi, description={Coordinated Universal Time}}
\newglossaryentry{C0}{name={\ensuremath{C_0}}, description={Atlantic Daylight Time}}
...
%\newglossaryentry{AMM & 	Autorisation de mise sur le marché\\
